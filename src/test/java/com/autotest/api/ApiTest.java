...
import com.autotest.api.beans.ApiDataBean;
import com.autotest.api.configs.ApiConfig;
import com.autotest.api.listeners.AutoTestListener;
import com.autotest.api.listeners.RetryListener;
import com.autotest.api.utils.FileUtil;
import com.autotest.api.utils.RandomUtil;
import com.autotest.api.utils.ReportUtil;
import com.autotest.api.utils.SSLClient;
...
public class ApiTest extends TestBase {
	...
	@Parameters("envName")
	@BeforeSuite
	public void init(@Optional("api11-config.xml") String envName) throws Exception {
		String configFilePath = Paths.get(System.getProperty("user.dir"), envName).toString();
		ReportUtil.log("api11 config path:" + configFilePath);
	...
	@BeforeTest
	public void readData(@Optional("case/api11-data.xls") String excelPath, @Optional("Sheet1") String sheetName) throws DocumentException {
